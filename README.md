## BB Car Rental
A simple Ruby on Rails CRUD application for managing a car rental service. The project allows creating/editing users, reservations and cars (in progress).
...
* Cars: Parking lot management (Make, Model, Year, Count, Availability) (in progress).
